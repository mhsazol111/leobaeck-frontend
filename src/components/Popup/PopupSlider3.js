...
const popupSlider3 = () => {
	const closePopupFunc = () => {
		document.querySelector('.popupSlider3').classList.remove('active_mod');
	};

	return (
		<div className="popup side_mod popupSlider3">
			...
			<div className="popup_in side_mod">
				...
				<div className="popup_content">
					<div className="panel_slider">
						<PopupItem content={APP_DATA.popupObject} />
					</div>
				</div>
			</div>
		</div>
